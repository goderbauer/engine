...
std::unique_ptr<Surface> EmbedderSurfaceMetal::CreateGPUSurface(int64_t view_id)
...
GPUMTLTextureInfo EmbedderSurfaceMetal::GetMTLTexture(const SkISize& frame_info,
